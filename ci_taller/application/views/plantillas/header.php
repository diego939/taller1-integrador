          ...
          <fieldset id="redondo">
            <legend><strong>Iniciar Sesión</strong></legend>
              <div id="imputs-sesion">
                <?php echo form_input(['name' => 'usuario', 'id' => 'sombraredondeada', 'class' => 'form-control','placeholder' => 'Ingrese su Email', 'autofocus'=>'autofocus', 'value'=>set_value('usuario_name')]); ?>
                <span class="text-danger"><?php echo form_error('usuario'); ?> </span>
              </div>
              <div id="imputs-sesion">
               <?php echo form_input(['name' => 'usuario_password', 'id' => 'sombraredondeada', 'type' => 'password', 'class' => 'form-control','placeholder' => 'Ingrese Contraseña', 'value'=>set_value('usuario_password')]); ?>
                <span class="text-danger"><?php echo form_error('usuario_password'); ?> </span>
              </div>
              <div id="abajo-sesion">
