<main id="contenido">
   <h1 class="img-carrito2" id="titulo_pagina"> Mi Perfil </h1>
   <br>
...
<br><br>
<a href="<?= base_url()?>logueadoControler/Editar_datos" type="button" id="sombraredondeada-log" class="btn btn-secondary btn-lg btn-block">Editar Mis Datos</a><br>
<a href="<?= base_url()?>logueadoControler/editar_contra" type="button" id="sombraredondeada-log" class="btn btn-secondary btn-lg btn-block">Cambiar Contraseña</a>
<br><br>
</div>
</div>
</fieldset>
