<main id="contenido">  
    <h1 id="titulo_pagina" style="filter: grayscale(100%);" class="img-carrito"> Archivo De Clientes</h1>
    ...
    <div class="img-carrito2 table-responsive bg-white mt-4">
      <table id="mytable" class="table table-bordred table-striped table-hover">
        ...
        <?php foreach($consultas as $row) { ?>
            <tr class="danger"> 
              <?php if($row->leido == 1){?>
                <td style="color:black";><a title="Marcar como no leido" class="btn btn-link" href="<?php echo base_url("administrador_controler/leido_consulta_clientes/$row->id_consulta");?>" role="button">leido</a></td>
                ...
                <td style="color:black";><a title="Leer Consulta" href="<?php echo base_url("administrador_controler/visualizar_consulta_clientes/$row->id_consulta");?>" class="img-carrito2 btn btn-outline-secondary">📂</a> </td>
                <td style="color:black";><a title="Quitar del Archivo" href="<?php echo base_url("administrador_controler/desarchivar_consulta_clientes/$row->id_consulta");?>" class="img-carrito2 btn btn-outline-secondary">✘</a></td>
              <?php } else {?>
                ...
                <td style="color:black";><strong><a title="Quitar del archivo" href="<?php echo base_url("administrador_controler/desarchivar_consulta_clientes/$row->id_consulta");?>" class="img-carrito2 btn btn-outline-secondary">✘</a></strong></td>
               <?php } ?> 
            </tr>
        <?php } ?>
        </tbody>
