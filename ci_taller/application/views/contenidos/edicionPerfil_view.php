<main id="contenido">
    <br>
    <h1 id="titulo_pagina" class="img-carrito">Editar mis datos</h1>
    <br>
    <?php echo form_open("logueadoControler/actualizar_usuario/$id_usuario", ['class' => 'form-signin', 'role' => 'form']); ?>
