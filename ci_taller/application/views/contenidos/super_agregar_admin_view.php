...
<section>
  ...
  font-size:14px;"> 
    <strong>AGREGAR USUARIOS ADMINISTRADORES</strong>
  </div>
    <br><br><br>
      ...
      <div>
        ...
        <?php
          $data = array(
                  ...
                  'rows'        => '5',
              'cols'        => '10',
              'placeholder' => ' Ingrese direccion del Administrador...'
                );
