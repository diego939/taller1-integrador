<main id="contenido">
  ...
  <section id="">
    <?php echo form_open_multipart('logueadocontroler/registrar_consulta', ['class' => 'form1', 'role' => 'form1']); ?>
    <form class="form-horizontal" ><br>
      ...
      <div>
        ...
        <div class="col-sm-12 controls">
          ...
          <a title="Limpiar Campos" href="<?= base_url()?>UsuarioContacto" id="sombraredondeada-log" class="btn btn-block mt-4" >Limpiar Campos</a>
        </div> 
        <?php echo form_close(); ?>
      </fieldset>
    </form>
