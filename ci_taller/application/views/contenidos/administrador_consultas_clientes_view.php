<main id="contenido">  
    <h1 id="titulo_pagina" style="filter: grayscale(100%);" class="img-carrito"> Consultas De Clientes</h1>
        ...
        <?php foreach($consultas as $row) { ?>
            <tr class="danger">
              <?php if($row->leido == 1){?>
                ...
                <td style="color:black";><a title="Archivar Consulta" href="<?php echo base_url("administrador_controler/archivar_consulta_clientes/$row->id_consulta");?>" class="img-carrito2 btn btn-outline-secondary">💾</a></td>
              <?php } else {?>
