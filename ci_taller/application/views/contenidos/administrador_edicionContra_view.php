<main id="contenido">
    <br>
    <h1 id="titulo_pagina" style="filter: grayscale(100%);" class="img-carrito">Cambiar conteaseña</h1>
    <br>
    <?php echo form_open("administrador_controler/actualizar_usuario_contra/$id_usuario", ['class' => 'form-signin', 'role' => 'form']); ?>
