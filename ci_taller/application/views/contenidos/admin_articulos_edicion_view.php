...
<?php echo form_open_multipart("administrador_controler/actualizar_articulos/$id_articulo", ['class' => 'form-signin', 'role' => 'form']); ?>
  ...
  <div class="m-auto">
    <div><img src="<?php echo base_url("/assets/upload/$imagen");?>" class="img-carrito card-img-top img-fluid rounded-pill" width="250" heigh="150"></div><br>
            ...
            <a style="filter: grayscale(100%);" class="img-carrito2 btn btn-danger btn-block" href="<?= base_url("administrador_controler/actualizar_img_art/$id_articulo")?>">Cambiar Imagen <span class="sr-only"></span></a>
</div>
